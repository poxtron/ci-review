...
final class PhpcsScanDoScanTest extends TestCase {
	...
	public function testDoScanTest1() {
		...
		$temp_file_contents
			= '<?php' . PHP_EOL . 'echo time();' . PHP_EOL . 'echo "foo" . PHP_EOL;' . PHP_EOL
			  . 'echo esc_html( strip_tags("foo") ) . PHP_EOL;' . PHP_EOL . PHP_EOL;
