...
final class GitHubPrGenericSupportCommentTest extends TestCase {
	...
	public function testPostingNotConfigured() {
		...
		$this->options['post-generic-pr-support-comments-branches'] = [ 'any' ];
	...
	public function testPostingWorksSpecificBranch() {
		...
		$this->options['post-generic-pr-support-comments-branches'] = [ 'master' ];
	...
	public function testPostingSkippedInvalidBranch() {
		...
		$this->options['post-generic-pr-support-comments-branches'] = [ 'myinvalidbranch0xfff' ];
	...
	protected function setUp() {
		...
		$this->options['token'] = $this->options['github-token'] = vipgoci_unittests_get_config_value(
			'git-secrets',
			'github-token',
		...
		$this->options['commit'] = $this->options['test-github-pr-generic-support-comment-1'];
