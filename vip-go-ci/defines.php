...
define(
	...
	'GitHub API communication error. ' . 'Please contact a human.'
);
...
define(
	...
	'This bot provides automated ' . 'PHP Linting and PHPCS scanning, ' . 'read more [here](%s).'
);

define(
	'VIPGOCI_FILE_IS_APPROVED_MSG',
	'File is approved in review database ' . '(hashes-to-hashes).'
);

define(
	'VIPGOCI_REVIEW_COMMENTS_TOTAL_MAX',
	'Total number of active review comments per ' . 'Pull-Request has been reached and some ' . 'comments might not appear as a result. '
	. 'Please resolve some issues to see more'
);

define(
	'VIPGOCI_PHPCS_INVALID_SNIFFS',
	'Invalid PHPCS sniff(s) specified in ' . 'options or options file (option ' . '`phpcs-sniffs-exclude`). Those have '
	. 'been ignored temporarily. Please ' . 'update the options so that scanning ' . ' can continue as expected. ' . '<br /><br /> '
	. 'The sniffs are: '
);
